...
//  $('header').addClass('open');
   ...
   $('.search__advanced').click(function(){
      ...
      $('.filter-search').toggleClass('none');
      $('.box__search').toggleClass('open');
     
    });  
  
   $('.close').click(function(){
     $('.box__search').removeClass('open');
      $('.filter-search').toggleClass('none');
   });  
  
   $('.blue__border.close').click(function(){
     $(this).closest('form.search__form').find("input[type=text], textarea").val("");
   });  
  
  
  
    $('.box__style__list>a.tab').click(function(){
      
      var dataT = $(this).data('tab');

      $('.box__style__list>a').removeClass('active');
      $('.box__style__list>a:nth-child('+ dataT + ')').addClass('active');
      
      if(dataT === 1){
         $('#search-response>.block__').addClass('not__see');
//        $('#search-response>.block__>.post__preview').hide();
      }else if(dataT === 2){
//         $('#search-response>.block__>.post__preview').show();
        $('#search-response>.block__').removeClass('not__see');
      }

     });  
  
    $('.box__tab>a.tab').click(function(){
      
      var dataT = $(this).data('tab');

      $('.box__tab>a').removeClass('active');
      $('.box__tab>a:nth-child('+ dataT + ')').addClass('active');
...
//
//    var selectBox = $('select#select_Period');
//    selectBox.addClass('none');
//    selectBox.wrap('<div class="select__"></div>');
//    selectBox.after('<div class="select-styled"></div>');
//
//    var styledSelect = selectBox.next('div.select-styled');
//    styledSelect.text(selectBox.children('option').eq(0).text());
//
//    var list = $('<ul />', {
//        'class': 'select-options'
//    }).insertAfter(styledSelect);
//
//    $("select#select_Period > option").each(function() {
////      console.log(" affiche "+this);
//        $('<li/>').attr("rel", this.value - 1).appendTo(list).text(this.text);
//    });
//
//
...
//        selectBox.children('option').eq($(this).attr('rel')).attr("selected", "selected");
//        styledSelect.toggleClass('active').next('ul.select-options').toggle();
//        $(document).off("click");
////        calculatorSlide();
//    });
...
//$(document).ready(function() {
//
//    var nselectBox = $('select#select_host');
//    nselectBox.addClass('none');
//    nselectBox.wrap('<div class="select__"></div>');
//    nselectBox.after('<div class="select-styled"></div>');
//
//    var nstyledSelect = nselectBox.next('div.select-styled');
//    nstyledSelect.text(nselectBox.children('option').eq(0).text());
//
//    var list = $('<ul />', {
//        'class': 'select-options'
//    }).insertAfter(nstyledSelect);
//
//    $("select#select_host > option").each(function() {
////      console.log(" affiche "+this);
//        $('<li/>').attr("rel", this.value - 1).appendTo(list).text(this.text);
//    });
//
//
//    nstyledSelect.click(function(e) {
//        e.stopPropagation();
//        if (!$(this).hasClass('active'))
//            $(document).click(function() {
//                styledSelect.toggleClass('active').next('ul.select-options').toggle();
...
//    listItems.click(function(e) {
//        e.stopPropagation();
//        nstyledSelect.text($(this).text());
//        nselectBox.children('option').eq($(this).attr('rel')).attr("selected", "selected");
//        nstyledSelect.toggleClass('active').next('ul.select-options').toggle();
//        $(document).off("click");
////        calculatorSlide();
//    });
//
